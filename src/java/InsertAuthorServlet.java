...
public class InsertAuthorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertAuthorServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertAuthorServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");*/
        }
    }
        ...
        response.setContentType("text/html");  
            ...
            String email=request.getParameter("email").trim();
              try{  
               ...
               // pw.println(isbn_no);
                // pw.println(title);
                 ...
                 // pw.println(author_id);
                  // pw.println(publisher_date);
                   // pw.println(available_copies);
               ...
               String q = "insert into author(AuthorID,A_name,Email)values('"+author_id+"','"+author_name+"','"+email+"')";
